...
// 定义语言类型
export type Language = 'zh' | 'en' | 'ja' | 'it';
...
const translations: Record<Language, Record<string, string>> = {
  ...
  it: {
    'title': 'Il mio lavoro vale la pena?',
    'github': 'GitHub',
    'email': 'E-mail',
    'xiaohongshu': 'Rednote',
    'redirect_notice': 'Reindirizzamento automatico, non è necessaria alcuna VPN',
    'visits': 'Visite',
    'visitors': 'Visitatori',
    'star_request': 'Se trovi utile questo strumento, assegnagli una stella!',
    'history': 'Storia',
    'no_history': 'Nessun record storico',
    'history_notice': 'I record verranno salvati dopo aver visualizzato i report',
    ...
    'salary_placeholder_cny': 'Stipendio annuo al lordo delle imposte',
    'salary_placeholder_foreign': 'Utilizza la valuta locale',
    'salary_placeholder': 'Stipendio annuo al lordo delle imposte',
    'non_china_salary': 'Retribuzione fuori dalla Cina',
    'ppp_factor': 'Fattore di parità del potere d\'acquisto',
    'ppp_tooltip': 'Il fattore PPP standardizza il potere d’acquisto tra i paesi. Ad esempio, il valore 4,19 della Cina significa che 1 USD negli Stati Uniti ha lo stesso potere d\'acquisto di 4,19 CNY in Cina.',
    'ppp_placeholder': 'Inserisci il fattore di conversione PPP',
    'ppp_common_regions': 'Regioni comuni: Cina:4,19, Giappone:102,59, Stati Uniti:1,00, Singapore:0,84',
    'view_more': 'Visualizza altro',
    'country_selection': 'Paese/regione di lavoro',
    'selected_ppp': 'Valore PPP attuale',
    'work_days_per_week': 'Giorni lavorativi/settimana',
    'wfh_days_per_week': 'Giorni di WFH/settimana',
    'wfh_tooltip': 'WFH significa lavoro da casa. Inserisci quanti giorni lavorativi settimanali trascorri lavorando da casa.',
    'annual_leave': 'Ferie annuali (giorni)',
    'public_holidays': 'Giorni festivi',
    'paid_sick_leave': 'Giorni di malattia retribuiti',
    'work_hours': 'Ore di lavoro al giorno',
    'work_hours_tooltip': 'Orario di lavoro: tempo totale dall\'inizio alla fine della giornata lavorativa, compresi pasti, pause e straordinari (esclusi gli spostamenti).',
    'commute_hours': 'Ore di tragitto',
    'commute_tooltip': 'Il tempo di percorrenza si riferisce al tempo totale di andata e ritorno tra casa e ufficio.',
    'rest_time': 'Pausa e tempo libero (ore)',
    'job_stability': 'Stabilità del lavoro',
    'job_government': 'Settore pubblico',
    'job_state': 'Azienda statale o grande impresa',
    'job_foreign': 'Compagnia straniera',
    'job_private': 'Azienda privata',
    'job_dispatch': 'Lavoratore di agenzia interinale',
    'job_freelance': 'Libero professionista',
    'work_environment': 'Ambiente di lavoro',
    'env_remote': 'Stabilimento remoto/cantiere/esterno',
    'env_factory': 'Fabbrica/sito/esterno',
    'env_normal': 'Ufficio standard',
    'env_cbd': 'Ufficio CBD',
    'city_factor': 'Città (per costo della vita)',
    'city_tier1': 'Metropoli principale',
    'city_newtier1': 'Nuova metropoli emergente',
    'city_tier2': 'Centro regionale',
    'city_tier3': 'Città di medie dimensioni',
    'city_tier4': 'Piccola città',
    'city_county': 'Contea',
    'city_town': 'Cittadina',
    'hometown': 'Lavori nella tua città natale?',
    'not_hometown': 'Fuori città natale',
    'is_hometown': 'Nella città natale',
    'leadership': 'Direttore/Capo',
    'leader_bad': 'Relazione difficile',
    'leader_strict': 'Gestione rigorosa',
    'leader_normal': 'Professionale e neutrale',
    'leader_good': 'Leadership di supporto',
    'leader_favorite': 'Membro della cerchia ristretta',
    'teamwork': 'Ambiente di squadra',
    'team_bad': 'Ambiente tossico',
    'team_normal': 'Colleghi professionali',
    'team_good': 'Squadra collaborativa',
    'team_excellent': 'Squadra affiatata',
    'shuttle': 'Servizio navetta (bonus)',
    'shuttle_none': 'Inaccessibile',
    'shuttle_inconvenient': 'Navetta scomoda',
    'shuttle_convenient': 'Navetta comoda',
    'shuttle_direct': 'Navetta con percorso diretto',
    'canteen': 'Qualità della mensa (Bonus)',
    'canteen_none': 'Mensa pessima',
    'canteen_average': 'Mensa discreta',
    'canteen_good': 'Mensa buona',
    'canteen_excellent': 'Mensa eccellente',
    'education_level': 'Livello di istruzione',
    'degree_type': 'Tipo di laurea',
    'below_bachelor': 'Diploma o inferiore',
    'bachelor': 'Laurea triennale',
    'masters': 'Laurea magistrale',
    'phd': 'Dottorato di ricerca',
    'school_type': 'Tipologia universitaria',
    'school_second_tier': 'Università standard',
    'school_first_tier_bachelor': 'Migliori Università/QS200/USnews80',
    'school_elite_bachelor': 'Elite University/QS50/USnews30',
    'school_first_tier_higher': 'Scuola di specializzazione superiore/QS100/USnews50',
    'school_elite_higher': 'Elite Grad School/QS30/USnews20',
    'bachelor_background': 'Sfondo di laurea',
    'work_years': 'Esperienza di lavoro',
    'fresh_graduate': 'Neolaureato',
    'years_1_3': '1-3 anni',
    'years_3_5': '3-5 anni',
    'years_5_8': '5-8 anni',
    'years_8_10': '8-10 anni',
    'years_10_12': '10-12 anni',
    'years_above_12': '12+ anni',
    'working_days_per_year': 'Giorni lavorativi/anno',
    'days_unit': 'giorni',
    'average_daily_salary': 'Salario medio giornaliero',
    'job_value': 'Valutazione del valore del lavoro',
    'view_report': 'Visualizza il mio rapporto sul valore del lavoro',
    'share_back_to_calculator': 'Torna al calcolatore',
    'share_your_job_worth_report': 'Il tuo rapporto sul valore del lavoro',
    'share_job_worth_report': 'Rapporto sul valore del lavoro',
    'share_custom_made': 'Creato su misura da "Vale la pena il mio lavoro?"',
    'share_generating': 'Generazione in corso...',
    'share_download_report': 'Scarica il rapporto',
    'share_basic_info': 'Informazioni di base',
    'share_work_city': 'Città del lavoro',
    'share_is_hometown': 'Città natale',
    'share_yes': 'Sì',
    'share_no': 'No',
    'share_daily_salary': 'Stipendio giornaliero',
    'share_day': 'giorno',
    'share_days': 'giorni',
    'share_work_hours_title': 'Orario di lavoro',
    'share_hours': 'ore',
    'share_daily_work_hours': 'Ore di lavoro al giorno',
    'share_daily_commute_hours': 'Pendolarismo quotidiano',
    'share_rest_time': 'Pausa e riposo',
    'share_weekly_work_days': 'Giorni lavorativi alla settimana',
    'share_remote_work': 'Lavoro remoto',
    'share_days_per_week': 'giorni a settimana',
    'share_shuttle_service': 'Servizio navetta',
    'share_annual_leave': 'Ferie annuali',
    'share_paid_sick_leave': 'Malattia retribuita',
    'share_days_per_year': 'giorni all\'anno',
    'share_work_environment_title': 'Ambiente di lavoro',
    'share_office_environment': 'Ambiente d\'ufficio',
    'share_leadership_relation': 'Rapporto con la dirigenza',
    'share_colleague_relationship': 'Rapporto con i colleghi',
    'share_canteen_quality': 'Qualità della mensa',
    'share_education_and_experience': 'Istruzione ed esperienza',
    'share_highest_degree': 'Titolo di studio più elevato',
    'share_school_type_label': 'Tipo di scuola',
    'share_work_years_label': 'Anni di esperienza',
    'share_contract_type_label': 'Tipo di contratto',
    'share_final_assessment': 'Valutazione finale',
    'share_low_value_assessment_1': 'Questo lavoro sembra una lotta quotidiana, con sfide che superano i benefici.',
    'share_low_value_assessment_2': 'Questo lavoro è piuttosto impegnativo, ma potrebbe essere un trampolino di lancio verso migliori opportunità.',
    'share_medium_value_assessment_1': 'Questo lavoro è equilibrato, non particolarmente entusiasmante ma stabile e gestibile.',
    'share_medium_value_assessment_2': 'Questo lavoro offre buone soddisfazioni e ricompense all\'altezza dell\'impegno.',
    'share_high_value_assessment_1': 'Questo lavoro soddisfa la maggior parte delle tue aspettative, fornendo un lavoro significativo e un equo compenso.',
    'share_high_value_assessment_2': 'Questo lavoro sembra fatto su misura per te, con il giusto equilibrio tra sfide e benefici.',
    'share_high_value_assessment_3': 'Hai trovato un\'opportunità straordinaria che offre valore e soddisfazione eccezionali!',
    'share_working_days_per_year': 'Giorni lavorativi all\'anno',
    'share_hometown_comment': 'Lavorare nella tua città natale ti consente di costruire la tua carriera mantenendo i legami familiari: un equilibrio prezioso che contribuisce alla soddisfazione generale della vita.',
    'share_not_hometown_comment': 'Ricordati di prenderti cura di te stesso: mangia e riposa con regolarità, soprattutto vivendo lontano da casa.',
    'share_tier1andnewtier1_city_comment': 'Sebbene il costo della vita sia elevato nelle principali aree metropolitane, le abbondanti opportunità e le reti professionali possono accelerare la crescita della tua carriera.',
    'share_tier2and3_city_comment': 'Questi centri regionali offrono un buon equilibrio: opportunità di carriera dignitose con costi della vita e pressione lavorativa più gestibili rispetto alle principali città.',
    'share_tier4andbelow_city_comment': 'Godi di una buona qualità di vita con costi di vita inferiori. Sebbene le opportunità di carriera possano essere più limitate, il ritmo rilassato e la minore pressione rappresentano vantaggi significativi.',
    'share_commute_short': 'Il tuo breve tragitto giornaliero ti regala ogni giorno più tempo prezioso per lo sviluppo personale o il relax.',
    'share_commute_medium': 'Il tuo tragitto moderato è gestibile e può diventare un momento per leggere o ascoltare podcast.',
    'share_commute_long': 'Il tragitto molto lungo assorbe tempo prezioso e incide sull\'equilibrio vita-lavoro. Valuta un trasferimento o modalità più flessibili, se possibile.',
    'share_wfh_high': 'La tua sostanziale soluzione di lavoro da casa riduce significativamente il carico di pendolarismo e migliora la qualità della vita.',
    'share_wfh_medium': 'Il tuo lavoro parziale da casa ti aiuta a risparmiare tempo prezioso per gli spostamenti.',
    'share_shuttle_service_good': 'Il servizio navetta aziendale è un vantaggio prezioso che rende i tuoi spostamenti più comodi e senza stress.',
    'share_cbd_environment': 'L\'ufficio nel CBD offre un contesto professionale e accesso rapido a servizi e networking.',
    'share_factory_environment': 'Lavorare in stabilimenti o all\'aperto è impegnativo, ma rafforza resilienza e problem solving.',
    'share_normal_environment': 'Il tuo luogo di lavoro offre i servizi essenziali per lavorare con concentrazione.',
    'share_leadership_good': 'La tua leadership di supporto riconosce i tuoi contributi e fornisce la guida necessaria per il successo: una preziosa risorsa sul posto di lavoro.',
    'share_leadership_excellent': 'Far parte del nucleo di fiducia porta opportunità e influenza, ma richiede di gestire aspettative molto elevate.',
    'share_leadership_normal': 'Il tuo rapporto professionale con la leadership è diretto e funzionale: aspettative chiare senza inutili complicazioni.',
    'share_leadership_strict': 'Lavorare sotto una gestione rigorosa può essere impegnativo, ma spesso sviluppa disciplina e attenzione ai dettagli che ti servono bene a livello professionale.',
    'share_leadership_bad': 'La tensione con la dirigenza richiede comunicazione attenta e focus sui risultati.',
    'share_teamwork_excellent': 'I forti legami personali con i colleghi creano una rete di supporto che migliora sia la soddisfazione che l’efficacia sul lavoro.',
    'share_teamwork_good': 'L\'ambiente collaborativo del tuo team favorisce il supporto reciproco e una comunicazione efficace, rendendo il lavoro quotidiano più piacevole e produttivo.',
    'share_teamwork_normal': 'Mantenere rapporti professionali ma non eccessivamente personali con i colleghi consente di concentrarsi sul proprio lavoro pur avendo un supporto adeguato.',
    'share_teamwork_bad': 'Relazioni difficili impongono adattabilità e favoriscono indipendenza e resilienza.',
    'share_workhours_balanced': 'L\'orario equilibrato lascia spazio alla vita privata e sostiene performance durature.',
    'share_workhours_long': 'Le ore lunghe sono gestibili, ma richiedono attenzione per evitare affaticamento.',
    'share_workhours_excessive': 'Un orario troppo lungo può pesare su benessere e rendimento: valuta di ridurre il carico.',
    'share_rest_adequate': 'La tua generosa pausa aiuta a mantenere livelli di energia e produttività durante tutta la giornata lavorativa.',
    'share_rest_insufficient': 'Poche pause richiedono momenti di movimento per proteggere salute e concentrazione.',
    'share_leave_abundant': 'La tua generosa indennità di congedo offre ampio tempo per il ringiovanimento e le attività personali, essenziali per una motivazione duratura.',
    'share_leave_limited': 'Con poche ferie, pianifica strategicamente ogni giorno di riposo per ricaricarti.',
    'share_phd_comment': 'La tua qualifica di dottorato apre le porte a posizioni specializzate e dimostra capacità di ricerca e analitiche avanzate.',
    'share_masters_comment': 'La tua laurea magistrale dimostra competenze avanzate e dedizione, ancora molto apprezzate nel mercato del lavoro.',
    'share_bachelor_comment': 'La tua laurea triennale offre basi solide che, unite all’esperienza pratica, ampliano le opportunità di carriera.',
    'share_below_bachelor_comment': 'Anche senza una laurea completa, le tue competenze pratiche restano preziose: valorizza l’esperienza sul campo.',
    'share_fresh_graduate_comment': 'Come neolaureato, la tua nuova prospettiva e le conoscenze attuali sono risorse, bilanciate dal potenziale illimitato di crescita e apprendimento.',
    'share_experienced_comment': 'La tua esperienza consolidata rafforza giudizio, efficacia e sicurezza.',
    'share_mid_career_comment': 'Con diversi anni di esperienza, comprendi sia il tuo settore che i punti di forza personali, posizionandoti per lo sviluppo strategico della carriera.',
    'share_government_job_comment': 'La stabilità del settore pubblico riduce l\'incertezza e facilita la pianificazione futura.',
    'share_private_job_comment': 'Il privato è più dinamico: richiede adattabilità ma offre crescita e reddito maggiori.',
    'share_dispatch_job_comment': 'Lavorare tramite agenzia è flessibile ma poco stabile: pianifica con cura il tuo futuro.',
    'share_freelance_job_comment': 'Il freelance garantisce autonomia, ma richiede gestione rigorosa e continuità di incarichi.',
    'share_salary_high_cny': 'La tua retribuzione giornaliera è competitiva e fornisce sicurezza finanziaria e flessibilità sia per le necessità che per le spese discrezionali.',
    'share_salary_medium_cny': 'Il tuo compenso soddisfa comodamente i bisogni di base ma richiede un budget attento per una salute finanziaria ottimale.',
    'share_salary_low_cny': 'L\'attuale retribuzione impone attenzione ai conti mentre cerchi nuovi progressi.',
    'share_salary_high_foreign': 'La tua retribuzione giornaliera è competitiva e fornisce sicurezza finanziaria e flessibilità sia per le necessità che per le spese discrezionali.',
    'share_salary_medium_foreign': 'Il compenso copre le esigenze di base, ma richiede un budget attento per restare solido.',
    'share_salary_low_foreign': 'Il tuo attuale livello di retribuzione richiede un\'attenta gestione finanziaria mentre esplori le opportunità di crescita del reddito.',
    'share_high_cost_city': 'Nelle aree care serve pianificazione finanziaria per sfruttare al meglio il reddito.',
    'share_low_cost_city': 'In zone dal costo ridotto aumenta il potere d\'acquisto e la capacità di risparmio.',
    'share_value_low': 'Anche un ruolo poco conveniente può offrire esperienza: cogli ogni lezione per il passo successivo.',
    'share_value_medium': 'Il lavoro ha pro e contro: valorizza i punti di forza e affronta gradualmente le criticità.',
    'share_value_high': 'Hai trovato un ruolo ad alto valore: coltiva i tuoi punti di forza e trai il massimo dalla soddisfazione che offre.',
    'share_summary_advice': 'Consiglio complessivo',
    'rating_enter_salary': 'Inserisci lo stipendio',
    ...
    'rating_perfect': 'Perfetta',
    'share_country': 'Paese/regione di lavoro'
  },
...
export const LanguageProvider: React.FC<{children: ReactNode}> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedLanguage && (savedLanguage === 'zh' || savedLanguage === 'en' || savedLanguage === 'ja' || savedLanguage === 'it')) {
