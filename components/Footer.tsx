      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-center items-center gap-6 mb-2">
          ...
          >
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 shadow-sm transform transition-all duration-200 group-hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 10-2 0v3a1 1 0 102 0v-3zm2-3a1 1 0 011 1v5a1 1 0 11-2 0v-5a1 1 0 011-1zm4-1a1 1 0 10-2 0v7a1 1 0 11-2 0V8z" clipRule="evenodd" />
              </svg>
            </div>
            <span className="text-xs mt-1.5 text-gray-700 dark:text-gray-300 font-medium">{t('footer_offerselect')}</span>
          </a>
          ...
          >
            ...
            <span className="text-xs mt-1.5 text-gray-700 dark:text-gray-300 font-medium">{t('footer_city_compare')}</span>
          </a>
          ...
          >
            ...
            <span className="text-xs mt-1.5 text-gray-700 dark:text-gray-300 font-medium">{t('footer_ai_exam')}</span>
          </a>
          ...
          >
            ...
            <span className="text-xs mt-1.5 text-gray-700 dark:text-gray-300 font-medium">{t('footer_perler_beads')}</span>
          </a>
        </div>
        <div className="text-center">
          <span className="text-[10px] text-gray-400 dark:text-gray-500">{t('footer_more_tools')}</span>
        </div>
      </div>
    </footer>
  );
